...
export default function ProgressBar3D({ value = 0, height = 14 }) {
  ...
  // Адаптивный максимум: шкала ВСЕГДА длиннее достижения — «можно больше»
  const maxVal = (v * 1.6) || 1
  ...
  return (
    <div style={{ position: 'relative', height, borderRadius: height, background: 'rgba(0,0,0,0.55)', border: '1px solid rgba(255,255,255,0.07)', boxShadow: 'inset 0 2px 6px rgba(0,0,0,0.8), 0 1px 0 rgba(255,255,255,0.06)', overflow: 'hidden' }}>
      {/* Заблюрованный потенциальный прогресс — мотивация «всегда можно больше» */}
