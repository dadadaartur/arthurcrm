...
export default function Home() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      {/* Заголовок без облака, градиентный текст хорошо виден */}
      <div className="text-center mb-10 select-none">
        ...
        <p className="text-gray-700 text-lg max-w-xl mx-auto backdrop-blur-sm bg-white/30 rounded-full py-2 px-6">
          Просто скажите, что нужно сделать, и мы подберём лучшие инструменты
        </p>
      </div>

      {/* Облачные подсказки – теперь реалистичные облака */}
