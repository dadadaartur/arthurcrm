  ...
  return (
    <div className="theme-light max-w-lg mx-auto px-4 py-10">
      ...
      <div className="premium-card" style={{ padding: 28 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, padding: '14px 18px', borderRadius: 16, background: 'rgba(234,88,12,0.06)', border: '1px solid var(--border-gold)' }}>
                      ...
                      filteredColleagues.map(c => (
                        ...
                        >
                          {c.avatar_url ? (
                            ...
                            <div style={{ width: 28, height: 28, borderRadius: '50%', background: 'rgba(234,88,12,0.12)', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, color: 'var(--accent-gold)' }}>
