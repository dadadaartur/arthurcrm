          ...
          <div className="dash-card lg:w-1/2">
            ...
            <form onSubmit={handleCreateTask} className="flex flex-col gap-4">
              <div className="flex gap-4 items-end">
                ...
                <div>
                  <label className="text-sm text-gray-400">Иконка (эмодзи)</label>
            ...
            {tasks.map(task => (
              <div key={task.id} className="dash-card">
                <div className="flex justify-between">
                  <h4 className="text-white">{task.icon} {task.title}</h4>
            ...
            <div className="space-y-6">
              {pendingReviews.map(item => (
                <div key={item.id} className="premium-card flex flex-col">
                  <div className="flex justify-between">
                    <div>
                      <h4 className="text-white font-semibold">{item.tasks.icon} {item.tasks.title}</h4>
            ...
            <div className="space-y-2">
              {history.map(h => (
                <div key={h.id} className="flex justify-between items-center p-2 rounded bg-gray-800">
                  <div>
                    <span className="text-white">{h.tasks.icon} {h.tasks.title}</span>
