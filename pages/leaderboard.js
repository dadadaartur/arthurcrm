  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="premium-card">
        ...
        {leaders.length === 0 ? (
          <p className="text-[var(--lumen-ink-faint)]">Нет данных</p>
        ) : (
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-[var(--lumen-line)]">
            ...
            <tbody>
              {leaders.map((leader, idx) => (
                <tr key={leader.user_id} className="border-b border-[var(--lumen-line)] hover:bg-gray-50">
