...
export default function MyTasksAnalytics() {
  ...
  return (
    <div className="theme-light" style={{ minHeight: '100vh', fontFamily: 'Inter, sans-serif', padding: '40px 32px', position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'fixed', top: '-10%', right: '-8%', width: 420, height: 420, borderRadius: '50%', background: 'radial-gradient(circle, rgba(234,88,12,0.10), transparent 70%)', filter: 'blur(10px)', pointerEvents: 'none' }} />
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, rgba(234,88,12,0.07), rgba(124,58,237,0.05))', border: '1px solid var(--border-gold)', borderRadius: 20, padding: 26, marginBottom: 20 }}>
