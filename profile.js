        ...
        <div style={sectionStyle}>
          ...
          {stats && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 14px', borderRadius: 14, background: 'rgba(234,88,12,0.06)', border: '1px solid var(--border-gold)' }}>
