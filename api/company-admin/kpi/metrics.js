...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    ...
    const { data, error } = await a.from('kpi_metrics').insert({
      ...
      period: ['daily', 'weekly', 'monthly', 'quarterly', 'once'].includes(b.period) ? b.period : 'daily',
  ...
  if (req.method === 'PUT') {
    ...
    if (fields.period !== undefined) fields.period = ['daily', 'weekly', 'monthly', 'quarterly', 'once'].includes(fields.period) ? fields.period : 'daily'
